...
def stop(cfs, extra):
    ...
    while any(wrong_side(cf, ex) for cf, ex in zip(cfs, extra)):
        raw_input("unaligned stop, please try again...")
...
def main():
    ...
    raw_input("press button to enter formation...")
    formation_simultaneous(cfs, extra)

    raw_input("press button to start ellipse...")
    ...
    raw_input("press button to land...")
    print("landing")
