...
class Crazyflie:
    ...
    def takeoff(self, targetHeight, duration, groupMask=0):
        if self._isGroup(groupMask):
            ...
            takeOff_pub = rospy.Publisher('/crazyflie2/command/trajectory', MultiDOFJointTrajectory, queue_size=10)
    ...
    def land(self, targetHeight, duration, groupMask=0):
        if self._isGroup(groupMask):
            ...
            land_pub = rospy.Publisher(
                '/crazyflie2/command/trajectory', MultiDOFJointTrajectory, queue_size=10)
